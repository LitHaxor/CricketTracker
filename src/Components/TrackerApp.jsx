...
import {
  decrementWicket,
  incrementWicket,
} from "../Services/Actions/CountWicket";
      ...
      case "rv":
        switch (stk[stk.length - 1]) {
          ...
          default:
            if (
              (balls === 0 && over === 0) ||
              (!stk[stk.length - 1] === "NB" && !stk[stk.length - 1] === "wd")
            ) {
              break;
            }
      ...
      <div className="flex-row container">
        <div className="card">
          <div className="card-header bg-primary text-center">
            <h1 className="text-white">{props.inningns}</h1>
          </div>
              ...
              <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                  <h3 className="text-left text-danger">
                    {" "}
                    Sure you want to finish the Match?
                  </h3>
                </Modal.Body>
                <Modal.Footer>
                  <button
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <h6 className="text-center alert alert-danger">
              <span className="text-info">{target - runs} runs</span> to win
              from{" "}
              <span className="text-success">
                {last * 6 - (over * 6 + balls)} balls
              </span>
            </h6>
          </div>
          <div className="card-body d-flex justify-content-around">
          ...
          <div className="card-body d-flex justify-content-around flex-wrap">
            ...
            <div className="button-group">
              <a href="/TrackerApps" role="button" className="btn btn-success">
                Finish Match
              </a>
            </div>
          </div>
